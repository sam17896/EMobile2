...
public class SkillAdapter extends ArrayAdapter{
    ...
    boolean s;
    public SkillAdapter (Activity activity, int resource, ArrayList<String> names, boolean s) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if(convertView == null)
            vi = inflater.inflate(R.layout.skills, null);

        TextView name = (TextView) vi.findViewById(R.id.skill);
